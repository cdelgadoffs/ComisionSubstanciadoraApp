...
export default function Sidebar2({ abierto = true, izquierda = 0, badge, subtitulo, onCerrar, children }) {
  return (
    <aside className={'lvl1-sidebar2' + (abierto ? '' : ' lvl1-sidebar2-oculto')} style={{ left: izquierda }}>
